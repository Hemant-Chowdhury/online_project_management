...
<div
		...
		<div style="height: auto; width: 100%; padding: 0px; float: left;">
			...
			<c:forEach items="${project}" var = "p">
				<li class="list-group-item" style="margin: 2px; height: auto;">
					<a href="/guest/home/project?projectId=${p.getProjectId()}">
					${p.getProjectName()}
					</a>
				</li>
			</c:forEach>
	...
	<div
		...
		<div style="width: 100%; float: left;">
			<h4 class="heading" style="margin-left: 0px;">Overdue Tasks</h4>
		</div>
		<hr class="hr"
			style="width: 100%; height: 1px; margin: 0.5px; background-color: black; float: left; display: block;">
		<div style="height: auto; width: 100%; padding: 0px; float: left;">
			...
			<c:forEach items="${pastTask}" var = "past">
				<li class="list-group-item" style="margin: 2px; height: auto;">
					<a href="/guest/home/task?taskId=${past.getTaskId()}">
					${past.getTaskName()}
					</a>
				</li>
			</c:forEach>
	...
	<div
		...
		<div style="height: auto; width: 100%; padding: 0px; float: left;">
			...
			<c:forEach items="${presentTask}" var = "present">
				<li class="list-group-item" style="margin: 2px; height: auto;">
					<a href="/guest/home/task?taskId=${present.getTaskId()}">
					${present.getTaskName()}
					</a>
				</li>
			</c:forEach>
	...
	<div
		style="width: 17%; float: left; padding: 10px; height: auto; background-color: #ddd; margin: 5px;">
		<div style="width: 100%; float: left;">
			<h4 class="heading" style="margin-left: 0px;">Upcoming Tasks</h4>
		</div>
		<hr class="hr"
			style="width: 100%; height: 1px; margin: 0.5px; background-color: black; float: left; display: block;">
		<div style="height: auto; width: 100%; padding: 0px; float: left;">
			...
			<c:forEach items="${futureTask}" var = "future">
				<li class="list-group-item" style="margin: 2px; height: auto;">
					<a href="/guest/home/task?taskId=${future.getTaskId()}">
					${future.getTaskName()}
					</a>
				</li>
			</c:forEach>
	...
	<div
		...
		<div style="height: auto; width: 100%; padding: 0px; float: left;">
			...
			<c:forEach items="${completedTask}" var = "completed">
				<li class="list-group-item" style="margin: 2px; height: auto;">
					<a href="/guest/home/task?taskId=${completed.getTaskId()}">
