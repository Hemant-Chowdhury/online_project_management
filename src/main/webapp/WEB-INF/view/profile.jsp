...
<div
	...
	<center>
		<div class="card" style="width: 250px; margin-top: 10px;">
			<img class="card-img-top" src="${pageContext.request.contextPath}${user.getImage()}" alt="Card image">
			<div class="card-body">
	...
	<div class="panel panel-default"
		...
		<form:form action="/user/profile?update=profile" method="post" commandName="user">
